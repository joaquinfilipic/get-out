...
@Entity
@Table(name = "Reject", uniqueConstraints = {
...
public class Reject {
	...
	@Id
	@Column(name = "id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "reject_id_seq")
	@SequenceGenerator(sequenceName = "reject_id_seq", name = "reject_id_seq", allocationSize = 1)
	private Long id;
	...
	public Reject(final Builder builder) {
		id = builder.id;
